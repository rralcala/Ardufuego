...
*/
  ...
  class FireplaceRF 
  {
    ...
    private:
      ...
      const unsigned int MSG_REPEAT = 10;
      ...
      // Raw header message
      const unsigned long header[8] = {876, 428, 372, 428, 880, 436, 368, 1264};

      const unsigned long start_cmd[3][8] = {
        {XX, XX, OO, XX, XX, OO, XX, OO},
      ...
      void transmitRaw(const unsigned long msg[], const unsigned int msgSize);
